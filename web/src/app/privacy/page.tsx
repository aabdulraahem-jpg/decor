          ...
          <article className="card space-y-6 text-gray-800 leading-loose">
            ...
            <Section title="4. أغراض المعالجة والأساس النظامي">
              <ul className="list-disc pr-5 space-y-1.5">
                ...
                <li><strong>الفوترة والمحاسبة:</strong> الاحتفاظ بسجلات الفواتير لفترة لا تقلّ عن 10 سنوات — <em>أساس: التزام نظامي (نظام ضريبة القيمة المضافة في السعودية)</em>.</li>
